...
- A `llama-server` build from [llama.cpp](https://github.com/ggml-org/llama.cpp) — not included in the repo, path configurable in Settings. **Tested with build `b10782` (win-cuda-12.4-x64)** — other versions use different CLI flags and may not work correctly
